...
gMatrix <- t(matrix(c(-1,.3,-.2,.15,-1,.23,-.31,.2,-1),3,3))
...
load('shinyApps/CoopCompSphere/datosCoopComp.RData')


# Define la UI de la aplicación
ui <- fluidPage(
  
  titlePanel("The inner structure of biodiversity (cooperative/competitive version)"),
